<%@ Page Language="C#" MasterPageFile="~/Admin/Adminmst.Master" AutoEventWireup="true" CodeBehind="ModifyClub.aspx.cs" Inherits="ClubSphere.Admin.ModifyClub" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="form-container">
        ...
        <div class="form-group">
            <label for="ddlClub">Select Club:</label>
            <asp:DropDownList ID="ddlClub" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlClub_SelectedIndexChanged"></asp:DropDownList>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <asp:Button ID="btnUpdateClub" runat="server" Text="Update Club" CssClass="btn-submit" OnClick="btnUpdateClub_Click" />
        </div>
        <div class="message">
